      ...
      <main>
        ...
        <Card className="card">
          <div className="card-style">
            <SubHeading text={this.state.campaignText} body={this.state.bodyText} className="-m-b-0" />
            <CampaignInfo campaign={this.state.campaign} changeHandler={this.setCampaignInfo}/>
            <HR className="-m-b-4"/>
